                  ...
                  <li class="relative flex items-center w-full">
                    ...
                    <li class="relative flex items-center w-full">
                      <div class="flex items-center text-teal-600 relative group">
                        ...
                        <div class="desk absolute top-0 -ml-12 text-center mt-12 w-32 text-xsb capitalize text-gray-900 border-green">Shipped</div>
                      </div>
           ...
           <div class="basis-full sm:basis-3/4 md:basis-3/5 lg:basis-3/5 xl:basis-4/6 2xl:basis-4/6">
                <div class="w-full rounded border-t-[3px] border-t-[#48cef3] py-4 bg-white">
                            <div class="w-full flex items-center justify-between px-6">
                                  ...
                                  <a href="/cart/seller-buy-step-4" class="bg-transparent text-firoza border border-firoza py-1 px-2 rounded font-medium text-sm flex items-center justify-center w-[116px] h-[36px]">
            ...
            <div class="flex w-full flex-col mt-5">
              ...
              <ol role="list" class="overflow-hiddens">
                ...
                <li class="relative pb-10">
                  ...
                  <div class="-ml-px absolute mt-0.5 top-4 left-4 w-0.5 h-full bg-gray-300 bg-green" aria-hidden="true"></div>
                ...
                <div class="w-full border-t border-gray-200 flex flex-col pt-4 px-6"> 
                  ...
                  <div class="w-full flex flex-col pl-7">
                    ...
                    <div class="w-full flex justify-end mt-10 px-6">
                          ...
                          <a href="/cart/seller-buy-step-4" class="bg-transparent text-firoza border border-firoza py-1 px-2 rounded font-medium text-base flex items-center justify-center w-[135px] h-[42px]">
                                <span>View Invoice</span>
                          </a> 
