          ...
          <!-- no menu end -->
                    ...
                    <div class="block items-end justify-end sm:flex md:flex mb-3 border-b-2 pb-3 border-gray-200 px-2">
                            ...
                            <div class="relative z-0 w-[110px] ml-4" >
                                ...
                                <a href="/gintaa-food/vendor/add-menu" class="border border-green flex justify-center items-center bg-transparent py-1.5 px-4 rounded bg-green text-base text-white">
               ...
               <!-- seamer loader start  -->
            <div v-if="showSeamerLoader" class="relative w-full bg-white overflow-hidden shadow hover:shadow-md rounded-lg  px-4 sm:px-4 md:px-4 lg:px-6  divide-y divide-slate-200">
         ...
         <!-- seamer loader end -->
               ...
               <div class="w-full px-4 sm:px-4 md:px-4 lg:px-6">
                <div class="accordion" id="accordionExample5">
                    ...
                    <div v-if="menuListItems.length == 0 && !showSeamerLoader" class="w-full cart-empty px-4 py-4 bg-white">                                            
                                            <div class="flex items-center justify-center"><img src="~assets/images/food/no-dishes.svg" alt="image" class="w-[240px] h-[190px]" ></div> 
                                            <div class="text-lg text-gray-900 font-medium mb-3 text-center">No dish found</div>
                                        </div> 

                    <div v-else v-for="(menu,index) in menuListItems" :key="index" class="accordion-item bg-white border border-gray-200 mb-4">
                        ...
                        <button class="accordion-button collapsed relative flex items-center w-full py-3 px-4 text-sm font-medium text-gray-800 text-left bg-white
                            ...
                            :data-bs-target="'#menu-list-expandable-container'+index" 
                            aria-expanded="false" 
                            aria-controls="collapseOne5">
                            {{ menu.name }} 
                            <span v-if="menu.subCategories.length == 0" class="ml-2 text-sm">({{ menu.foodListings.length }})</span>
                            <span v-else class="ml-2 text-sm">({{ menu.subCategories.length }})</span>
                        </button>
                        </h2>
                        <div v-if="menu.subCategories.length == 0" 
                            :id="'menu-list-expandable-container'+index" 
                            ...
                            <div class="accordion-body py-0 px-0">
                                <div class="overflow-x-auto">
                                    <div class="inline-block w-full py-0 align-middle">
                                        <div class="shadow-sm">
                                        <table class="min-w-full divide-y divide-gray-300 table-auto" style="border-spacing: 0">
                                            <thead class=" bg-transparent">
                                            <tr>
                                                <th scope="col" class="sticky top-0 z-10  px-3 py-2 text-left text-sm font-semibold text-gray-900  w-[25%]">Product Name</th>
                                                <th scope="col" class="sticky top-0 z-10  px-3 py-2 text-center text-sm font-semibold text-gray-900  w-[25%]">Description</th> 
                                                <th scope="col" class="sticky top-0 z-10  px-3 py-2 text-center text-sm font-semibold text-gray-900  ">Food Type</th>  
                                                <th scope="col" class="sticky top-0 z-10  px-3 py-2 text-center text-sm font-semibold text-gray-900  ">State</th>                                                          
                                                <th scope="col" class="sticky top-0 z-10  px-3 py-2 text-center text-sm font-semibold text-gray-900 ">Price</th>
                                                <th scope="col" class="sticky top-0 z-10  px-3 py-2 text-center text-sm font-semibold text-gray-900 ">Action</th>
                                            </tr>
                                            </thead>
                                                    ...
                                                    <td class=" px-3 py-4 pl-8 text-sm text-[#44588F] w-[20%]">
                                                        <div class="flex items-center">
                                                            <div class="h-[70px] w-[90px] flex-shrink-0">
                                                                <img v-if="food.imageUrl" :src="food.imageUrl" alt="image" class="h-[70px] w-[90px] rounded">
                                                                <img v-else src="~/assets/images/food/consumer/no-dish.jpg" alt="image" class="h-[70px] w-[90px] rounded">
                                                            </div> 
                                                            <div class="ml-2">
                                                                <div class="font-medium text-[#44588F] text-sm">{{food.name}}</div>
                                                            </div>

                                                            <a :href="localePath(`/gintaa-food/vendor/menu/${food.id}`)"
                                    class="text-left text-sm text-green mt-2 font-medium">View Details</a>
                                                        </div>
                                                    </td>

                                                    <td class="whitespace-break-spaces px-3 py-2 text-xs text-[#44588F] text-center w-[20%]">
                                                        {{food.description}}
                                                    </td>
                                                    ...
                                                    <td class=" px-3 py-4 text-sm text-[#44588F] text-center">
                                                        <div class=" font-medium pl-[10px] flex items-center justify-center"> 
                                                        <span class="ml-0.5">{{food.sanity  ? 'Approved' : 'Inreview'}}</span></div>
                                                    </td>
                                                
                                                    <td class=" px-3 py-4 text-sm text-[#44588F] text-center">
                                                        <div class=" font-medium pl-[10px] flex items-center justify-center"><svg width="6" height="11" viewBox="0 0 11 18" fill="none" ><path opacity="0.7" fill-rule="evenodd" clip-rule="evenodd" d="M0 0.787369C0 0.352518 0.352517 0 0.787369 0H9.71263C10.1475 0 10.5 0.352517 10.5 0.787369C10.5 1.22222 10.1475 1.57474 9.71263 1.57474L7.423 1.57474C8.15198 2.31524 8.65471 3.26904 8.82286 4.33052H9.71263C10.1475 4.33052 10.5 4.68304 10.5 5.11789C10.5 5.55274 10.1475 5.90526 9.71263 5.90526H8.82288C8.4344 8.35801 6.25946 10.2358 3.63462 10.2358H2.28446L8.85412 16.6402C9.16954 16.9477 9.16954 17.4462 8.85412 17.7537C8.5387 18.0612 8.02729 18.0612 7.71187 17.7537L0 10.2359L3.52184e-05 10.2358H0V9.6611C0 9.10882 0.447716 8.6611 1 8.6611H3.63462C5.36438 8.6611 6.81192 7.48316 7.17918 5.90526L0.78737 5.90526C0.352518 5.90526 0 5.55274 0 5.11789C0 4.68304 0.352517 4.33052 0.787369 4.33052L7.17915 4.33052C6.81185 2.75267 5.36434 1.57478 3.63462 1.57478H0.787369C0.352517 1.57478 0 1.22226 0 0.787408V0.787369Z" fill="black"></path></svg> 
                                                        <span class="ml-0.5">{{food.price}}</span></div>
                                                    </td>
                                                    <td class=" px-3 py-4 text-sm text-[#44588F] text-center">
                                                        <div class="flex items-center justify-end">
                                                            <div v-if="!food.stockAvailable" @click="redirectToEditPage(food.id)" class="flex justify-center items-center border border-[#EA7000] rounded cursor-pointer w-[55px] h-[25px] px-1 py-1">
                                                                <svg width="12" height="12" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                        <path d="M16.4742 8.26917L5.93917 18.8017L0 20L1.19833 14.06L11.7325 3.52667L16.4742 8.26917ZM17.6525 7.09083L20 4.74083L15.2575 0L12.9108 2.3475L17.6525 7.09083Z" fill="#EA7000"/>
                                                                </svg>
                                                                <span class="text-[#EA7000] text-xs ml-1">Edit</span>
                                                            </div>
                                                            <div v-if="food.stockAvailable" class="flex justify-center items-center border border-[#808080] rounded w-[55px] h-[25px] px-1 py-1 opacity-50">
                                                                <svg width="12" height="12" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                        <path d="M16.4742 8.26917L5.93917 18.8017L0 20L1.19833 14.06L11.7325 3.52667L16.4742 8.26917ZM17.6525 7.09083L20 4.74083L15.2575 0L12.9108 2.3475L17.6525 7.09083Z" fill="#808080"/>
                                                                </svg>
                                                                <span class="text-[#808080] text-xs ml-1">Edit</span>
                                                            </div>
                                                            ...
                                                            <div  class="form-check form-switch pl-4"><label  for="flexSwitchCheckDefault" class="form-check-label inline-block text-gray-500 text-sm"> </label> 
                                                                    <input  type="checkbox" role="switch" id="flexSwitchCheckDefault" v-model="food.stockAvailable"
                        ...
                        <div :id="'menu-list-expandable-container'+index" class="accordion-collapse collapse" aria-labelledby="headingOne5">
                        <div class="accordion-body py-0 px-0">
                            <div class="overflow-x-auto">
                            <div class="inline-block w-full py-0 align-middle">
                                <div class="shadow-sm">
                                    <div v-for="(subCategory,i) in menu.subCategories" :key="i" class="accordion-item bg-white border border-gray-200">
                                        ...
                                        <button class="accordion-button collapsed relative flex items-center w-full py-2.5 pl-6 pr-4 text-sm font-medium text-green-800 text-left bg-white
                                            border-0 rounded-none transition focus:outline-none sub-menu-bg" type="button" 
                                            data-bs-toggle="collapse" 
                                            :data-bs-target="'#subCategory-expandable-container'+i+index" 
                                            aria-expanded="false"
                                            aria-controls="collapseTwo5">
                                            {{ subCategory.name }} <span class="ml-2 text-sm">({{ subCategory.foodListings.length }})</span>
                                        </button>
                                        </h2>
                                        <div :id="'subCategory-expandable-container'+i+index" class="accordion-collapse collapse" aria-labelledby="headingthree5">
                                            <div class="accordion-body py-0 px-0">
                                                <div class="overflow-x-auto">
                                                    <div class="inline-block w-full py-0 align-middle">
                                                        <div class="shadow-sm">
                                                            <table v-if="subCategory.foodListings.length > 0" class="accordion-table min-w-full divide-y divide-gray-300 table-auto" style="border-spacing: 0">
                                                            <thead class=" bg-transparent">
                                                            <tr>
                                                                <th scope="col" class="sticky top-0 z-10  px-3 py-2 pl-8 text-left text-sm font-semibold text-gray-900  w-[25%]">Product Name</th>
                                                                <th scope="col" class="sticky top-0 z-10  px-3 py-2 text-center text-sm font-semibold text-gray-900  w-[25%]">Description</th> 
                                                                <th scope="col" class="sticky top-0 z-10  px-3 py-2 text-center text-sm font-semibold text-gray-900  ">Food Type</th>
                                                                <th scope="col" class="sticky top-0 z-10  px-3 py-2 text-center text-sm font-semibold text-gray-900  ">State</th>                                                            
                                                                <th scope="col" class="sticky top-0 z-10  px-3 py-2 text-center text-sm font-semibold text-gray-900 ">Price</th>
                                                            ...
                                                            <tbody  class="divide-y divide-gray-200 bg-white">
                                                                <tr v-for="(food) in subCategory.foodListings" :key="food.id">
                                                                    <td class=" px-3 py-4 pl-8 text-sm text-[#44588F] w-[20%]">
                                                                        <div class="flex items-center">
                                                                            <div class="h-[70px] w-[90px] flex-shrink-0">
                                                                                <img v-if="food.imageUrl" :src="food.imageUrl" :alt="food.imageUrl" class="h-[70px] w-[90px] rounded">
                                    ...
                                    class="text-left text-sm text-green mt-2 font-medium">View Details</a>
                                                        ...
                                                        <table v-else class="accordion-table min-w-full divide-y divide-gray-300 table-auto" style="border-spacing: 0">
                                                            <thead class=" bg-transparent">
                                                            <tr>
                                                                <th scope="col" class="sticky top-0 z-10  px-3 py-2 pl-8 text-left text-sm font-semibold text-gray-900  w-[25%]">Product Name</th>
                                                                <th scope="col" class="sticky top-0 z-10  px-3 py-2 text-center text-sm font-semibold text-gray-900  w-[25%]">Description</th> 
                                                            ...
                                                            <tbody  class="divide-y divide-gray-200 bg-white">
                                                                <tr>
                                                                    <td class=" px-3 py-2 text-xs text-[#44588F] text-center w-[20%]">-</td>
                                                                    <td class=" px-3 py-2 text-xs text-[#44588F] text-center w-[20%]">-</td>
                                                                    <td class=" px-3 py-2 text-xs text-[#44588F] text-center w-[20%]">-</td>
                                                                    <td class=" px-3 py-2 text-xs text-[#44588F] text-center w-[20%]">-</td>
                                                                    <td class=" px-3 py-2 text-xs text-[#44588F] text-center w-[20%]">-</td>
                    ...
                    <div v-if="showDeleteFoodModal" class="relative z-50 " aria-labelledby="modal-title" role="dialog" aria-modal="true">
                    ...
                    <div class="fixed inset-0 z-50 overflow-y-auto">
                        ...
                        <div
                            ...
                            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                <h3 class="text-base font-semibold leading-6 text-gray-900" id="modal-title">Do you want to delete Food item?</h3>
                            </div>
                            </div>
                            <div class="mt-8 sm:mt-8 flex justify-end">
                            <button type="button" @click="closeRemoveFoodItemPopup"
                                class="flex w-[85px] justify-center items-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50">Cancel</button>
                            <button type="button" @click="deleteItem"
                                ...
                                <span v-show="!loading">Remove</span>
                    ...
                    <!-- <div class="accordion-item bg-white border border-gray-200">
                        ...
                        <button class="accordion-button collapsed relative flex items-center w-full py-1 px-4 text-sm font-medium text-gray-800 text-left
                            bg-white border-0 rounded-none transition focus:outline-none" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo5" aria-expanded="false"
                            aria-controls="collapseTwo5">
                            Chinese <span class="ml-2 text-sm">(20)</span>
                        </button>
                        </h2>
                                ...
                                <div class="inline-block min-w-full py-0 align-middle">
                                    <div class="shadow-sm overflow-x-auto">
                                            <table class="min-w-full divide-y divide-gray-300 table-auto" style="border-spacing: 0">
                                                <thead class=" bg-transparent">
                                                    <tr>          
                                                        <th scope="col" class="sticky top-0 z-10  px-3 py-2 text-left text-sm font-semibold text-gray-900  w-[20%]">Product Name</th>
                                                        <th scope="col" class="sticky top-0 z-10  px-3 py-2 text-center text-sm font-semibold text-gray-900  w-[20%]">Description</th> 
                                                        <th scope="col" class="sticky top-0 z-10  px-3 py-2 text-center text-sm font-semibold text-gray-900  ">Food Type</th>                                                            
                                                        <th scope="col" class="sticky top-0 z-10  px-3 py-2 text-center text-sm font-semibold text-gray-900 ">Price</th>
                                                        <th scope="col" class="sticky top-0 z-10  px-3 py-2 text-center text-sm font-semibold text-gray-900 ">Action</th>
                                                    </tr>
                                                ...
                                                <tbody  class="divide-y divide-gray-200 bg-white">
                                                    <tr>
                                                        <td class=" px-3 py-4 text-sm text-[#44588F] w-[20%]">
                                                            <div class="flex items-center">
                                                                <div class="h-[70px] w-[90px] flex-shrink-0">
                                                                    <img src="~/assets/images/food/kfc.webp" alt="image" class="h-[70px] w-[90px] rounded">
                                                                </div> 
                                                                <div class="ml-2">
                                                                    <div class="font-medium text-[#44588F] text-sm">Crisp Paper Masala Dosa</div>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td class=" px-3 py-2 text-xs text-[#44588F] text-center w-[20%]">
                                                            A fragrant combination of rice and succulent chicken pieces in a special blend of masala.(Item cannot be served with raita or salan)
                                                        </td>
                                                        <td class=" px-3 py-4 text-sm text-[#44588F] text-center">
                                                            <div class="flex items-center justify-center">
                                                            <svg width="20" height="19" viewBox="0 0 20 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        ...
                                                        <td class=" px-3 py-4 text-sm text-[#44588F] text-center">
                                                            <div class=" font-medium pl-[10px] flex items-center justify-center"><svg width="6" height="11" viewBox="0 0 11 18" fill="none" ><path opacity="0.7" fill-rule="evenodd" clip-rule="evenodd" d="M0 0.787369C0 0.352518 0.352517 0 0.787369 0H9.71263C10.1475 0 10.5 0.352517 10.5 0.787369C10.5 1.22222 10.1475 1.57474 9.71263 1.57474L7.423 1.57474C8.15198 2.31524 8.65471 3.26904 8.82286 4.33052H9.71263C10.1475 4.33052 10.5 4.68304 10.5 5.11789C10.5 5.55274 10.1475 5.90526 9.71263 5.90526H8.82288C8.4344 8.35801 6.25946 10.2358 3.63462 10.2358H2.28446L8.85412 16.6402C9.16954 16.9477 9.16954 17.4462 8.85412 17.7537C8.5387 18.0612 8.02729 18.0612 7.71187 17.7537L0 10.2359L3.52184e-05 10.2358H0V9.6611C0 9.10882 0.447716 8.6611 1 8.6611H3.63462C5.36438 8.6611 6.81192 7.48316 7.17918 5.90526L0.78737 5.90526C0.352518 5.90526 0 5.55274 0 5.11789C0 4.68304 0.352517 4.33052 0.787369 4.33052L7.17915 4.33052C6.81185 2.75267 5.36434 1.57478 3.63462 1.57478H0.787369C0.352517 1.57478 0 1.22226 0 0.787408V0.787369Z" fill="black"></path></svg> 
                                                            <span class="ml-0.5">450</span></div>
                                                        </td>
                                                        <td class=" px-3 py-4 text-sm text-[#44588F] text-center">
                                                            <div class="flex items-center justify-center">
                                                                <div class="flex justify-center items-center border border-[#EA7000] rounded cursor-pointer w-[65px] h-[30px] px-2 py-1">
                                                                    <svg width="14" height="14" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                            <path d="M16.4742 8.26917L5.93917 18.8017L0 20L1.19833 14.06L11.7325 3.52667L16.4742 8.26917ZM17.6525 7.09083L20 4.74083L15.2575 0L12.9108 2.3475L17.6525 7.09083Z" fill="#EA7000"/>
                                                                    </svg>
                                                                    <span class="text-[#EA7000] text-sm ml-1">Edit</span>
                                                                </div>
                                                                <div class="text-sm text-gray-500 ml-4">Out of stock: </div>
                                                                <div  class="form-check form-switch pl-4"><label  for="flexSwitchCheckDefault" class="form-check-label inline-block text-gray-500 text-sm"> </label> 
                                                    ...
                                                    <tr>
                                                        <td class=" px-3 py-4 text-sm text-[#44588F] w-[35%]">
                                                            <div class="flex items-center">
                                                                <div class="h-[70px] w-[90px] flex-shrink-0">
                                                                    <img src="~/assets/images/food/kfc.webp" alt="image" class="h-[70px] w-[90px] rounded">
                                                                </div> 
                                                        ...
                                                        <td class=" px-3 py-4 text-xs text-[#44588F] text-center">
                                                        A fragrant combination of rice and succulent chicken pieces in a special blend of masala.(Item cannot be served with raita or salan)
                                                    </td>
