<template>
  <div v-if="message.replyObj.messageType == 'HTML'" class="w-full">
    <div class="w-full bg-[#e6edfd] relative rounded py-1 pr-1 pl-2 border-l-[0.188rem] border-gray-300 mb-1">
      <div class="w-full text-sm text-pink-500 mb-1">
        {{ displayName }}
      </div>
  ...
  <div v-else-if="message.replyObj.messageType == 'IMAGE'" class="w-full">
    <div class="w-full bg-[#f8f8f8] flex items-center justify-between relative rounded py-1 pr-1 pl-2 border-l-[0.188rem] border-gray-300 mb-1">
      <div class="mr-5">
        <div class="w-full text-sm text-pink-500 mb-1">
          {{ displayName }}
        </div>
