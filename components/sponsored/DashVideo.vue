    ...
    <div class="mx-auto mt-5 lg:mt-0 lg:pb-10 ">
              <div class="">
                ...
                <div class="sponsered-img max-w-[1130px] mx-auto relative px-0 lg:px-0 ">
                  <div class="relative p-2 bg-gray-100" v-show="showDashVideoBtn" @click="showDashVideo()">
    
                    <a href="javascript:;" @click="logEventOnBtnClick(getDashimgUrlName(),getDashMobimgUrlName(),getDashVideoUrl())"
                    ...
                    <img :src="getDashimgUrlName()" class="mx-auto max-w-full hidden md:block" alt="Baazar Kolkata" />
                    <img :src="getDashMobimgUrlName()" class="mx-auto max-w-full md:hidden" alt="Baazar Kolkata" />
                   ...
                   <div v-if="!showDashVideoBtn" class="w-full max-w-[1130px] bg-black">
                    <div
...
export default Vue.extend({
  ...
  methods:{
    showDashVideo(){
    this.showDashVideoBtn = !this.showDashVideoBtn
    ...
    getDashimgUrlName() {
      ...
      switch (this.$i18n.locale) {
        case 'en':
          imageUrl = `${this.CDN_BASE_URL}/web/web_new/sponsored/dash-video-thumb.webp`
          break;
        default:
          imageUrl = `${this.CDN_BASE_URL}/web/web_new/sponsored/dash-video-thumb.webp`
      }
    ...
    getDashMobimgUrlName() {
      
      let imageUrl = `${this.CDN_BASE_URL}/web/web_new/sponsored/Thumbnail-mobile.jpg`
      return imageUrl
     
    },
    getDashVideoUrl() {
      return `${this.CDN_BASE_URL}/web/web_new/sponsored/dash-Video-new.mp4`
    },
    ...
    scrollEvent()
    {
       try {
        const analyticsData = {
          ...
          user_id: this.authUser ? this.authUser?.uid : null,
          sponsor_link: this.sponsorlink,
          video_url: this.getDashVideoUrl(),
          sponsored_by: this.sponsoredBy,
        };
