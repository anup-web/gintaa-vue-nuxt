    ...
    <template>
        <div>
          ...
          <div class="fixed z-50 inset-0 overflow-y-auto" id="edit-bank-account-modal" aria-labelledby="modal-title"
                ...
                <form>
                  <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <div class="sm:flex sm:items-start">
                      ...
                      <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                        <h3 class="text-lg leading-6 font-medium text-gray-900" id="modal-title">Update bank account</h3>
                        <div class="mt-2">
                          <p class="text-sm text-gray-500">Please update your correct bank or UPI details carefully. They will
                  ...
                  <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                    <a v-if="selectedPaymentType === 'UPI'" :disabled="!isUpiDetailsValid"
                      ...
                      class="w-full relative min-w-[130px] inline-flex justify-center rounded border border-transparent shadow-sm px-4 py-2 bg-firoza text-base font-medium text-white  sm:ml-3 sm:w-auto sm:text-sm">Update
      ...
      export default Vue.extend({
       ...
       props: ["editedItem"],
        ...
        mounted() {
          let modal = document.getElementById("edit-bank-account-modal")!;
          modal.style.display = "block";
          
          let payMnetType = this.editedItem?.bankAccountDetails ? 'BANK' : 'UPI'
          this.chnagePaymentMethod(payMnetType);
          console.log("editedItem",this.editedItem )
          if(this.editedItem && this.editedItem.bankAccountDetails){
            this.paymentTypes.push({id: 1, name: "Bank", slug: "BANK", checked: true})
          }else{
            this.paymentTypes.push({ id: 2, name: "UPI Id", slug: "UPI", checked: true })
          }
          this.selectedEditedId = this.editedItem.id
          console.log("this.editedItem",this.editedItem)
         this.acntDetailsObj.nickName =  this.editedItem?.nickName
         this.acntDetailsObj.accountNumber =  this.editedItem?.bankAccountDetails?.accountNumber
         this.acntDetailsObj.confirmaccountNumber = this.editedItem?.bankAccountDetails?.accountNumber
         this.acntDetailsObj.ifsc =  this.editedItem?.bankAccountDetails?.ifsc
         this.acntDetailsObj.upiId =  this.editedItem?.upiId
        ...
        methods: {
          ...
          closeModalWithRes() {
            ...
            this.$emit('accountUpdated', true);
          },
          closeModal() {
            let modal = document.getElementById("edit-bank-account-modal")!;
            modal.style.display = "none";
            this.$emit('closeeditAcntMod', true);
            this.selectedEditedId = ''
          },
