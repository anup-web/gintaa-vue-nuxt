            ...
            <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                <div
                    ...
                    <div class="flex flex-col w-full px-6 mt-2">
                        <div class="text-base text-gray-900 font-normal">Block Listing</div>
                    </div>
                    ...
                    <div class="w-full flex justify-center items-center pt-2 px-6">
                        <div class="text-sm text-gray-500 text-center"> why you want to block this
                            listing ?</div>
                    </div>
                    ...
                    <div class="bg-gray-50 py-3 flex justify-end px-6">
                        ...
                        <button :disabled="!isformValid" :class="!isformValid ? 'opacity-50' : 'opacity-100'"
                            @click="blokeLisitng()" type="button"
...
export default Vue.extend({
    name: "BlocktListing",
    props: ["showBlockPopup", "productDet"],

    mounted() {
        console.log("showblockmodal", this.showBlockPopup, this.productDet);
    },
    data() {
        return {
            isformValid: false,
    ...
    methods: {
        ...
        async blokeLisitng() {
            ...
            try {
                let url = `/offers/v1/blocked/offer/user/block/${offerId}`;
